...
import { ChevronLeft, ChevronRight, Plus, Download, Trash2, Info, X, Moon, Sun, Menu, RefreshCw, HelpCircle } from 'lucide-react';
...
const CalendarApp = () => {
        ...
        <div className="is-flex is-align-items-center is-justify-content-space-between mb-3 pb-2" style={{ borderBottom: useDark ? '1px solid #334155' : '1px solid #e2e8f0' }}>
          <div className="is-flex is-align-items-center" style={{ gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            {!isExport && (
              <button
                type="button"
                onClick={() => setShowWhatIs4060Modal(true)}
  ...
  return (
    <section className="section px-4" style={{ minHeight: '100vh', paddingTop: '2.25rem', paddingBottom: '3rem', backgroundColor: isDarkMode ? '#0b0f17' : '#f8fafc', transition: 'background-color 0.25s ease' }}>
      ...
      {/* Modal explicativo: ¿Qué es esto? (Regla 40-60 y análisis normativo) */}
      {showWhatIs4060Modal && (
        <div className="modal is-active" style={{ zIndex: 1050 }}>
          <div className="modal-background" onClick={() => setShowWhatIs4060Modal(false)} />
          <div 
            className="modal-card" 
            style={{ 
              maxWidth: '760px', 
          ...
          >
            ...
            >
              ...
              <button 
                className="delete is-medium" 
                aria-label="close" 
                onClick={() => setShowWhatIs4060Modal(false)} 
                title="Cerrar ventana"
              />
            </header>
            ...
            >
              ...
              <section className="mb-4">
                ...
                <div className="content" style={{ fontSize: '0.88rem' }}>
              ...
              >
                <div className="message-body" style={{ color: isDarkMode ? '#cbd5e1' : '#475569', fontSize: '0.82rem' }}>
